...
def main():
	...
	# 5 FORMA ACTUAL
	evaluation_set(db_conn=db_conn, M=10, N=5, folds=5, out_path='TwitterRatings/funkSVD/data/tmpstmp/')
	evaluation_set(db_conn=db_conn, M=20, N=10, folds=5, out_path='TwitterRatings/funkSVD/data/tmpstmp/')
	evaluation_set(db_conn=db_conn, M=30, N=15, folds=5, out_path='TwitterRatings/funkSVD/data/tmpstmp/')
	evaluation_set(db_conn=db_conn, M=40, N=20, folds=5, out_path='TwitterRatings/funkSVD/data/tmpstmp/')
	# 6)
